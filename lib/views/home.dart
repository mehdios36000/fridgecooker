...
import 'package:fridgecooker/views/recipe_view.dart';
import 'package:fridgecooker/models/recipe_model.dart';
                        ...
                        InkWell(
                            onTap: () async {
                              if (textEditingController.text.isNotEmpty) {
                                ...
                                recipies = [];
                                String url =
                                    "https://api.edamam.com/search?q=${textEditingController.text}&app_id=5c47aed1&app_key=0f3bc07018ad9fcd3218fad54578c3f5";
                                ...
                                jsonData["hits"].forEach((element) {
                                  ...
                                  RecipeModel recipeModel = new RecipeModel(image:" ",url: " ",label: " ",source: " ");
                                  recipeModel =
